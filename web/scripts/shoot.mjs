...
const democableMode = arg("democable-mode", "straight"); // layout: straight | bend | close | vertical
...
try {
  if (democable) {
    await page.evaluate(({ w, m }) => window.__cecDemoCable?.(w, m), {
      w: Number(democableWidth),
      m: democableMode,
    });
