...
export const PART_META: Record<string, { desc: string; learnTier: string }> = {
  ...
  SRL: { desc: "Set/reset memory · cross-coupled", learnTier: "III" },
  DLATCH: { desc: "Transparent while EN high · holds", learnTier: "III" },
  JKFF: { desc: "Universal flip-flop · tie J=K for T", learnTier: "III" },
  TRI: { desc: "Drives A, or Hi-Z when OE low", learnTier: "III" },
  SAMP: { desc: "Quantizes 1 bit on the clock edge", learnTier: "II" },
  LUT: { desc: "4-input LUT · any function of 4 bits", learnTier: "III" },
  SPIM: { desc: "SPI master · clocks a word out", learnTier: "III" },
  SPIS: { desc: "SPI slave · replies when clocked", learnTier: "III" },
  UART: { desc: "Async serial · frames a byte", learnTier: "III" },
  ADC: { desc: "Flash: VIN -> 3-bit code, in parallel", learnTier: "III" },
  DAC: { desc: "R-2R ladder: 3-bit code -> voltage", learnTier: "III" },
  SAR: { desc: "Binary search: VIN -> code over 3 clocks", learnTier: "III" },
  SDM: { desc: "Oversampling: 1-bit stream -> code", learnTier: "III" },
  CTR: { desc: "3-bit up-counter · counts clock edges", learnTier: "III" },
...
export const PART_SYNONYMS: Record<string, string[]> = {
  ...
  CTR: ["counter", "binary counter", "ripple", "divider", "sequencer", "ramp"],
